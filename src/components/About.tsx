          ...
          <div className="flex flex-col space-y-6">
            <Card className="cyber-card">
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-4 text-secondary">Services</h3>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start">
                    <Lock className="h-5 w-5 text-primary mr-2 mt-1 flex-shrink-0" />
                  ...
                  <div className="flex items-start">
                    <Server className="h-5 w-5 text-primary mr-2 mt-1 flex-shrink-0" />
