...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-background border-t border-cyber-primary/30 py-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex space-x-4 mb-6">
            <a 
              ...
              className="text-foreground/70 hover:text-cyber-primary transition-colors"
              aria-label="LinkedIn"
            >
          ...
          <div className="text-center text-sm text-foreground/60">
            <p className="mb-2">Cybersecurity Analyst | Incident Response Specialist | Threat Intelligence Expert</p>
